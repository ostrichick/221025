...
//		Student[] studentList = new Student[] { s1, s2, s3 };
		Student[] studentList = new Student[] { new Student("홍길일", 230), new Student("홍길이", 190),
				new Student("홍길삼", 280) };
...
//			studentList[i] ;
		...
		int scoreList[] = { studentList[0].getTotalScore(), studentList[1].getTotalScore(),
...
//				maxScore = scoreList[i];
		...
		System.out.println("가장 큰 점수는 " + maxScore + ", 학생 이름은 " + studentList[scoreIndex].getName());
