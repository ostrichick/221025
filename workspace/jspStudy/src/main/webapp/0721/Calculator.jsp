...
<body>
		...
		<form action="calculator_result.jsp">
				...
				<br />
				<p>
						연산자 <br /> <input type="radio" name="oper" value="plus" /> + <br /><input
								type="radio" name="oper" value="minus"
						/> - <br /><input type="radio" name="oper" value="multi" /> * <br /><input
								type="radio" name="oper" value="divide"
						/> /
				</p>
				<br />
				<p>
